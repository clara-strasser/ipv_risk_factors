...
## Set path --------------------------------------------------------------------
path_data <- "/Users/clarastrasser/ipv_data/results/main/"
#path_save <- path where estimation results should be saved

## Load data -------------------------------------------------------------------
load(paste0(path_data, "model.RData"))
load(paste0(path_data, "stabsel.RData"))
load(paste0(path_data, "confintemoipv1.RData"))
...
path_data_raw <- "/Users/clarastrasser/ipv_data/data/final_data/"
load(paste0(path_data_raw, "data_imp_pmm_m1.RData"))
mean_masnoden <- mean(data_imp_pmm_m1$MasNoDen, na.rm = TRUE)
mean_eda_sex  <- mean(data_imp_pmm_m1$eda_sex,  na.rm = TRUE)
rm(data_imp_pmm_m1)
