...
## Set path --------------------------------------------------------------------
path_data <- "/dss/dsshome1/0B/ru23kek2"
path_save <- "/dss/dsshome1/0B/ru23kek2/"   # <- results are written here; adjust if needed
                                            # (must end in "/", it is pasted directly onto filenames)

## Load data -------------------------------------------------------------------
load(paste0(path_data, "/data_imp_pmm_alt.RData")) # main data
