...
# Convert data frame to LaTeX table
strong_cramers_table <- xtable::xtable(strong_cramers_table, caption = "Moderato to Strong Association Categorical Variables", label = "tab:cramersv")

# Print
print(strong_cramers_table)
