...
individual_part2 <- left_join(individual_part1, individual_gender_related, by = c("ID_PER", "ID_VIV", "CVE_ENT", "CVE_MUN", "T_INSTRUM"))

## Save data -----
path_rf <- "/Users/clara/Desktop/master_thesis/r_projects/ipv_risk_factors/data/"
save(individual_part2, file = paste0(path_rf,"individual_risk_factors.RData"))
