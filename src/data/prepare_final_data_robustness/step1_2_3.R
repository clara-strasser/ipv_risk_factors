...
path_save <- "/Users/clara/Desktop/master_thesis/plots/descriptives/non_imputed/"
path_data_save <- "/Users/clara/Desktop/master_thesis/r_projects/ipv_risk_factors/data/prep_data_robustness/"
...
endireh_2021 <- endireh_2021 %>%
  select(-c("edu_parlow", "edu_parmedium", "edu_parhigh", "ind_par", 
            "sep_ex", "vio_fis_ex", "vio_emo_ex", "vio_sex_ex", "vio_eco_ex", "ing_par", "ing_muj", "vio_exp_inf_par", "vio_inf_par"))
...
plaus_5 <- data[data$ingm_muj > 0 & data$empleo_vida == "no", ] # 94 implausible results
