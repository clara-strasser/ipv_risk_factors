...
# Questions:
# P14_1_10 - P14_1_22, P14_1_23AB and P14_1_24AB
...
# Level:
# no (1), yes (2)
# Aim: create variable "vio_emo_vida"

# Set columns
vio_emo <- paste0("P14_1_", c(10:22, "23AB", "24AB"))
...
# Summary stat:
colSums(is.na(vio_emo_df)) # max of  19436  NAs
...
head(vio_emo_df[, c(vio_emo, "vio_emo_vida")], n = 65)
sum(is.na(vio_emo_df$vio_emo_vida)) # 4911 NAs
sum(is.na(vio_emo_df$vio_emo_vida) & (vio_emo_df$T_INSTRUM == "A1" | vio_emo_df$T_INSTRUM == "A2")) # 0 NAs
sum((vio_emo_df$T_INSTRUM == "A1" | vio_emo_df$T_INSTRUM == "A2")) # 68540 Number (for P3_1 it is 68574 Number)


# Subset data set
vio_emo_df <- vio_emo_df %>%
  select(c("ID_VIV", "ID_PER", "CVE_ENT", "CVE_MUN", "T_INSTRUM", "vio_emo_vida"))
...
## Save data -----
emotional_ipv_vida <- vio_emo_df
save(emotional_ipv_vida, file = paste0(path_outcome,"emotional_ipv_vida.RData"))
